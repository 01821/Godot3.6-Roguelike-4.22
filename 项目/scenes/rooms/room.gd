...
func _close_entrance():
	for entry_position in entrance.get_children():
		tile_map_2.set_cell(0,tile_map.local_to_map(entry_position.global_position),0,Vector2(2,6))
		#tile_map.set_cellv(tile_map.world_to_map(entry_position.global_position),1)
		#tile_map.set_cellv(tile_map.world_to_map(entry_position.global_position) + Vector2.UP,2)
		pass
